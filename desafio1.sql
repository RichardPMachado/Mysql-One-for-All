...
INSERT INTO SpotifyClone.albuns(titulo_album, ano_lancamento, artista_id)
VALUES
  ('Renaissance', 2022, 1),
  ('Jazz', 1978, 2),
  ('Hot Space', 2022, 2),
...
INSERT INTO SpotifyClone.cancoes(titulo_cancao, duracao_cancao, album_id)
VALUES
  ('BREAK MY SOUL', 279, 1),
...
INSERT INTO SpotifyClone.seguidor_dos_artistas(usuario_id, artista_id)
VALUES
	(1, 1),
	(1, 2),
	(1, 3),
